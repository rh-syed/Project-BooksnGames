		...
		<section id="right_side">
			<form id="generalform" class="container" method="post" action="">
				...
				<div class="field">
					...
					<input type="text" class="input" id="username" name="username" maxlength="20" onblur="checkUsername()"/>
					<p class="hint">20 characters maximum (letters and numbers only)</p>
				</div>
				<div id="error_username"></div>
				<div class="field">
					<label for="email">Email</label>
					<input type="text" class="input" id="email" name="email" maxlength="80" onblur="checkEmail()"/>
				</div>
